...
enum ImmGrp1 : unsigned char {
	XG_ADD, XG_SUB = 5, XG_CMP = 7,
};

/** Emits an Immediate Group 1 instruction with a register as 2nd operand. */
static inline void asm_grp1_imm(struct Assembler *ctx, bool w, enum ImmGrp1 reg, enum Register rm, int32_t i) {
	uint8_t op;
