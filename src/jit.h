 ...
 */
struct Snapshot {
	/// The number of instructions executed before this snapshot was taken.
	uint16_t instruction_count,
		offset; ///< Offset into @ref Recording::snap_entries.
...
[[gnu::malloc]] struct Recording *record_new(struct Closure *f);
